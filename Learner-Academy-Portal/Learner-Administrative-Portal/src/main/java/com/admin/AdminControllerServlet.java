...
public class AdminControllerServlet extends HttpServlet {
	...
	private void login(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		if (username.toLowerCase().equals("makgu343@gmail.com") && password.toLowerCase().equals("#T_Helium14")) {
	...
	private boolean getCookies(HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		for (Cookie cookie : cookies) {
			...
			if (cookie.getName().equals("makgu343@gmail.com") && cookie.getValue().equals("#T_Helium14")) {
				check = true;
				break;
			} 
